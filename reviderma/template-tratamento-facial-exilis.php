<?php 
/* Template Name: Tratamento Facial - Exilis */
get_header('intern'); ?>

  <!-- INICIO SLIDER -->
  <div class='slider intern owl-carousel owl-theme'>
    <div class="item tratamento-facial-exilis">
      <div class="container">
        <div class="alinha">
          <h2>Pele</h2>
...
<main>
  ...
  <div class='antes-depois'>
    <div class='container'>
      <img src="<?php echo get_template_directory_uri(); ?>/img/imagem-exilis.png" alt="Imagem Exilis Elite">
    </div><!-- /container -->
  </div><!-- /antes-depois -->
  <!-- FIM ANTES - DEPOIS -->
