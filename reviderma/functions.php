...
function register_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'header-menu' => __('Header Menu', 'blank'), // Main Navigation
        'sidebar-menu' => __('Sidebar Menu', 'blank'), // Sidebar Navigation
        'extra-menu' => __('Extra Menu', 'blank') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    'name'              => __('Widget Area 1', 'blank'),
        'description'   => __('Description for this widget-area...', 'blank'),
        'id'            => 'widget-area-1',
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('View Article', 'blank') . '</a>';
}
...
// Shortcodes
add_shortcode('shortcode_demo', 'shortcode_demo'); // You can place in Pages, Posts now.
